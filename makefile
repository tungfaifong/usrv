...
# include
INC_ASIO = -I$(PATH_3RDPARTY)/asio-1.30.2
...
LINK_FLAGS = $(LIB_ALL) -lpthread -ldl #-luring

# define
DEFINE_ASIO = #-DASIO_HAS_IO_URING -DASIO_DISABLE_EPOLL
DEFINE_SPDLOG = -DSPDLOG_FMT_EXTERNAL
DEFINE += $(DEFINE_ASIO) $(DEFINE_SPDLOG)
